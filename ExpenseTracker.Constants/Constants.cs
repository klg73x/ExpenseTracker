namespace ExpenseTracker
{
    public class ExpenseTrackerConstants
    {
        ...
        public const string ExpenseTrackerAPI = "https://maximumexpensetrackerapi.azurewebsites.net";
        ...
        public const string IdSrv = "https://expensetrackeridsrv20180614071505.azurewebsites.net/identity";
